...
Effektiv søgning bør derfor ikke kun ses som en feature der bruges ved nød, men som et centralt element i brugeroplevelsen \cite{nielsen2001search}.

Med AI bliver søgning mere og mere avanceret, og brugere forventer i stigende grad at svaret, eller det de søger efter, bliver præsenteret direkte og hurtigt af en LLM, frem for en liste af links eller resultater der manuelt skal gennemgås (se bare på Google.com \cite{google2023sge}).
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[scale=0.42]{../img/indledning-tegning-1.png}
    \end{center}
    \caption{
        Overblik over systemets funktionalitet med eksempel: 
        1. En bruger søger på noget bestemt på gris.dk, i sit eget sprog.
...
\\
\\
\textbf{"Hvordan kan anvendelsen af embeddings til at skabe semantisk forståelse, 
    forbedre kvaliteten, relevansen og brugeroplevelsen af søgeresultater i en specialiseret vidensbank, 
    som Gris.dk, sammenlignet med en traditionel nøgleordsbaseret tilgang?"}

Problemformuleringen indeholder "fluffy" begreber og termer, med forholdsvis bløde værdier, der kan give udfordringer, når der skal evalueres på resultaterne i projektet. 
Senere i analyseafsnittet, vil det blive beskrevet, hvordan termer som "kvalitet", "relevans" og "brugeroplevelse" skal kunne blive så målbare som muligt.
